...
# Запуск сравнения
compare_results(
    gemini_file='/Users/alexoff/git/gribito_nadristito/metal_powders_llm/output.txt',
    mistral_file='/Users/alexoff/git/gribito_nadristito/metal_powders_llm/mistral_output.txt'
)